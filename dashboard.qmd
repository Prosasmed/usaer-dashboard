...
<div style="display: flex; flex-direction: column; align-items: center;">
  <img src="images/inclusive.png" width="30%" height="90%"/>
...
ld7_filtrado |>
  ...
  geom_text(aes(label = round(prop, 2)), 
            vjust = 1.5, color = "white", size = 4, fontface = "bold") +  # Etiquetas dentro de las barras
  scale_fill_manual(values = c("#D4C19C", "#13322B", "#B38E5D", "#621132")) +  # Colores personalizados
